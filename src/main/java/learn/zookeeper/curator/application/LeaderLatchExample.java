...
public class LeaderLatchExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            for (int i = 0; i < CLIENT_QTY; ++i) {
                ...
                example.addListener(new LeaderLatchListener() {
                    ...
                    public void isLeader() {
                        System.out.println(example.getId() +  ":I am leader. I am doing jobs!");
                    }

                    @Override
                    public void notLeader() {
                        System.out.println(example.getId() +  ":I am not leader. I will do nothing!");
                    }
                });
                example.start();
            }
            ...
            System.out.println("选中的leader是： " + currentLeader.getId());
            System.out.println("该leader准备放弃master " + currentLeader.getId());
            currentLeader.close();
