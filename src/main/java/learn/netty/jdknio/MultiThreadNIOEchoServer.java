...
public class MultiThreadNIOEchoServer {
    ...
    private void startServer() throws Exception {
        //工厂方法获得一个selector对象的实例
        selector = SelectorProvider.provider().openSelector();

        // 创建非阻塞的channel,它是所有客户端连接的父管道
        ...
        // channnel绑定到selector上，selector可以为channel服务
        // SelectionKey表示一对channel和selector的关系，当selector或channel关闭时，SelectionKey就消失
