...
public class RSAUtils {
    ...
    public static PublicKey loadPublicKeyByFile(String filepath) throws Exception {
        try {
            ...
            Certificate c = cf.generateCertificate(new FileInputStream("/home/kai/yhx.cer"));
    ...
    public static PrivateKey loadPrivateKeyByFile(String filepath, String alias, String password) throws Exception {
        try {
            ...
            ks.load(new FileInputStream("/home/kai/yhx.keystore"), password.toCharArray());
    ...
    public static void main(String[] args){
        String serverAlias = "";
        String clientAlias = "yhx";

        String serverPassword = "";
        String clientPassword = "353600";

//      String serverPrivateKey = "d:\\server.keystore";
//      String serverPublicKey = "d:\\server.cer";

        String clientPrivateKey = "/home/kai/yhx.keystore";
        String clientPublicKey = "/home/kai/yhx.cer";
//
...
//          srvPriKey = (RSAPrivateKey) RSAUtils.loadPrivateKeyByFile(serverPrivateKey, serverAlias, serverPassword);
            ...
            //导出.pfx的私钥
            String pfxFile="/home/kai/yhx.pfx";
            UtilTools.coverToPfx(clientPrivateKey,clientPassword,pfxFile);
